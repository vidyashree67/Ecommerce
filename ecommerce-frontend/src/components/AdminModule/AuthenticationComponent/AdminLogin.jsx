...
const AdminLogin = () => {
  ...
  // Handle changes in the admin login form input
  ...
  const handleAdminLogin = (event) => {
    ...
    // Validate admin login input and set errors
  ...
  // Handle when the admin login form is submitted
  useEffect(() => {
    // Check if there are no validation errors and the form has been submitted
    if (Object.keys(errors).length === 0 && submitted) {
      
      // Perform admin login API request and handle response
      axios.post(`${BASE_URL}api/admins/login`, admin)
      .then((response) => {
          ...
          <div className="card shadow my-5">
            ...
            <div className="card-body">
              <div className="container">
                ...
                {/* Form Title */}
                <h4 className="text-center mt-2 mb-4">Admin Login Form</h4>
                ...
                <form onSubmit={handleAdminLogin}>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <input
                      ...
                      name="email"
                      value={admin.email}
                      onChange={handleAdminLoginInput}
                  ...
                  {/* If not registered yet, provide a link to the admin registration page */}
                  <h6>Don't yet registered? 
                    <Link to="/admins/registration" className="text-dark fw-bold ms-2">Register</Link>
                  </h6>
